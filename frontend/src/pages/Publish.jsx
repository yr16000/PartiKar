...
export default function Publish() {
    ...
    const handlePlaceSelect = (place) => {
        ...
        setForm((prev) => ({ ...prev, ville: place.label || '', latitude: place.latitude, longitude: place.longitude }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // On demande que les champs essentiels soient remplis; latitude/longitude peuvent être null si l'utilisateur a tapé du texte libre
        const required = [form.marque, form.modele, form.immatriculation, form.annee, form.prixJour, form.ville, form.imageUrl];
